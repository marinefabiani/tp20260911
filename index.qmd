...
author:
  - name: Marine Fabiani
    ...
    email: marine.fabiani@etu.umontpellier.fr
...
- La question de la diversité des forêts tropicales fascine les écologues parce qu'elle a des enjeux très importants [@Gibson2011]. est qu'elle est difficile à comprendre [@Wright2002b].
...
- L'objectif est de comparer la diversité locale de la forêt de Paracou [@Gourlet-Fleury2004] et celle de BCI [@Raby2017].
...
Profils de diversité de Paracou (courbe bleue) parcelle 6 et BCI (courbe rouge).
La figure représente le nombre effectif d'espèces (nombre de Hill) en fonction de la diversité
:::

# Discussion

- Cette étude a permis de démontrer que la diversité des espèces est plus importante au sein de la forêt de Paracou que dans la forêt de BCI.
